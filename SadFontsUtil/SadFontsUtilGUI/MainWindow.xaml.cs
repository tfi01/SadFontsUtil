...
public partial class MainWindow : Window
{
    ...
    private void GeneratePreview()
    {
        ...
        try
        {
            ...
            _currentBitmap = new Bitmap(imageWidth, imageHeight, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
            ...
            txtPNGResolution.Text = _currentBitmap.Width + " x " + _currentBitmap.Height;
  ...
  ""SolidGlyphIndex"": 219
    ...
    private void txtCharHeight_TextChanged(object sender, TextChangedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }

    private void txtCharFrom_TextChanged(object sender, TextChangedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }

    private void txtCharTo_TextChanged(object sender, TextChangedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }

    private void txtGridSizeX_TextChanged(object sender, TextChangedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }

    private void txtGridSizeY_TextChanged(object sender, TextChangedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }

    private void txtGridCellX_TextChanged(object sender, TextChangedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }

    private void txtGridCellY_TextChanged(object sender, TextChangedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }

    private void chkGridLines_Click(object sender, RoutedEventArgs e)
    {
        if (_selectedFontPath != null) GeneratePreview();
    }
}
